...
import controller.FicharioEndereco;
...
public class CrudEndereco extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButtonAlter, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 30, -1, -1));
    ...
    private void jButtonAlterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterActionPerformed
        if (jTable.getSelectedRow() > -1) {
            try {
                ...
                if (enderecodps != null) {
                    ficharioAtual.alterar(enderecodps, id);
    ...
    private void atualizaTabela() {
        ...
        try {
            ...
            Logger.getLogger(CrudEndereco.class.getName()).log(Level.SEVERE, null, ex);
        }
