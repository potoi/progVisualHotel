 ...
 * @author Victor
 */
public class CrudEquipamento extends javax.swing.JInternalFrame {
    ...
    private void jButtonAlterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterActionPerformed
        if (jTable.getSelectedRow() > -1) {
            try {
                ...
                AddEquipamento tela = new AddEquipamento(null, true, produtoantes);
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        AddEquipamento tela = new AddEquipamento(null, true);
        tela.showDialog();
        atualizaTabela();
