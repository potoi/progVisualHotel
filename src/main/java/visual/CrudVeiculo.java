...
public class CrudVeiculo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButtonClienteF, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 360, -1, -1));
        ...
        getContentPane().add(jButtonClienteF1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 360, -1, -1));
    ...
    private void jButtonAlterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterActionPerformed
        if (jTable.getSelectedRow() > -1) {
            try {
                ...
                AddCarro tela = new AddCarro(this, true, produtoantes);
