 ...
 * @author Victor
 */
public class CrudPessoaF extends javax.swing.JFrame {
    ...
    public CrudPessoaF() {
        ...
        this.setTitle("Tabela: Cliente Físico");
        atualizaTabela();
    }
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        AddPessoaFisica tela = new AddPessoaFisica(this, true);
        tela.showDialog();
        atualizaTabela();
    ...
    private void jButtonAlterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterActionPerformed
        if (jTable.getSelectedRow() > -1) {
            try {
                ...
                AddPessoaFisica tela = new AddPessoaFisica(this, true, produtoantes);
