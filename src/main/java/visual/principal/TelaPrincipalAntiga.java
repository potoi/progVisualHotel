...
public class TelaPrincipalAntiga extends javax.swing.JFrame {
     ...
     */
    private static TelaPrincipalAntiga instance;

    private TelaPrincipalAntiga(String nome) {
        initComponents();
        jLabel1.setText("Bem vindo "+nome);
    }

    private TelaPrincipalAntiga() {
        initComponents();
    }

    public static TelaPrincipalAntiga voltarTelaPrincipal(String nome) {
        if (instance == null) {
            instance = new TelaPrincipalAntiga(nome);
        }
        return instance;
    }

    public static TelaPrincipalAntiga voltarTelaPrincipal() {
        if (instance == null) {
            instance = new TelaPrincipalAntiga();
        }
        return instance;
    }
